...
- **Secure Transmission**: Data transmitted over secure connections
- **Access Control**: Limited access to user data within the app
...
- **Ad Analytics**: Retained according to Google's privacy policy
...
- Reset advertising identifier through device settings
